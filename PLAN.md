...
- 不整合データで残高が負になった場合、子ども画面の手元タグとアプリ貯金は0未満にしない
...
目的: 子ども2人が、自分のタグ・貯金・目標・買えるものを常時確認する。
...
- 親画面から記録すると子ども画面の合計タグ、手元タグ、アプリ貯金が変わる
...
- implement: transactions合計、手元タグ、アプリ貯金を実装する
...
```text
あおい: 合計3 / 手元3 / アプリ貯金0 / レゴまであと5
はる: 合計10 / 手元3 / アプリ貯金7 / ポケモンのぬいぐるみをたっせい！
```
